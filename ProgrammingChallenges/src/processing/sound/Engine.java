...
public class Engine {
	...
	public static int[] soundFilePlayMono(float rate, float pos, float amp, float add, boolean loop, String path,
			float dur, int cue, int bus) {
		return methCla.soundFilePlayMono(rate, pos, amp, add, loop, path, dur, cue, bus);
	};

	public static int[] soundFilePlayMulti(float rate, float amp, float add, boolean loop, String path, float dur,
			int cue) {
	...
	public static int[] envelopePlay(int[] input, float attackTime, float sustainTime, float sustainLevel,
